...
export default function PurchaseItemModal({ onClose, onSave, initialItem,customerPOs }) {
    ...
    const [allocatedQty, setAllocatedQty] = useState(initialItem?.allocatedQty || "");
    ...
    const fetchItems = async () => {
        try {
            ...
            console.log("customer-pos items",data);
    ...
    const handleItemChange = (id) => {
        ...
        if (selected) {
            setAvailableQty(selected.availableQty || 0);
        } else {
            setAvailableQty(0);
        }
    };
